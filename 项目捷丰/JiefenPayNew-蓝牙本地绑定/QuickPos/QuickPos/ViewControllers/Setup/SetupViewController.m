...
//            if(iOS8){
//                
//                UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"联系我们" message:@"公司网址：http://www.jiefengpay.com 客服电话：021-31129501" preferredStyle:UIAlertControllerStyleAlert];
...
//            }else{
//            
//                UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"联系我们" message:@"公司网址：http://www.jiefengpay.com 客服电话:021-31129501" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"访问官网",@"拨打电话", nil];
...
//            [menuController showRootController:YES];
//            UIViewController *ctrl = [ctr visibleViewController];
//            [instructionsVc setHidesBottomBarWhenPushed:YES];
//            [[ctrl navigationController] pushViewController:instructionsVc animated:YES];
        }
            break;
        default:
            break;
