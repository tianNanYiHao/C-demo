...
- (void)viewDidLoad {
    ...
    JSContext *context = [self.webView valueForKeyPath:@"documentView.webView.mainFrame.javaScriptContext"]; //获取该UIWebview的javascript执行环境。
...
- (void)rightAction
{
    ...
    NSString *textJS = @"showAlert('这里是JS中alert弹出的message')";  //这是java运行的脚本
    [context evaluateScript:textJS]; // 执行脚本
}
