...
@interface TakingIDcardPositiveViewController ()<UIActionSheetDelegate,UIViewControllerTransitioningDelegate,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationBarDelegate,ResponseData,GKImagePickerDelegate,GKImageCropControllerDelegate>{
