...
- (void)viewDidLoad {
    ...
    //刷新方法事件
//    [self.incomedataTableView addHeaderWithTarget:self action:@selector(dropDown)];
//    [self.incomedataTableView addFooterWithTarget:self action:@selector(OnPull)];
...
//    [self.incomedataTableView headerEndRefreshing];//停止下拉刷新
//    [self.incomedataTableView footerEndRefreshing];//停止上拉刷新
...
//                [self.incomedataTableView footerEndRefreshing];//停止下拉刷新
                [self.incomedataTableView.footer endRefreshing];
            }else{
