...
- (void)viewDidLoad {
    ...
    //刷新方法事件
//    [self.WithdrawalOfRecordTableView addHeaderWithTarget:self action:@selector(dropDown)];
//    [self.WithdrawalOfRecordTableView addFooterWithTarget:self action:@selector(OnPull)];
...
//    [self.WithdrawalOfRecordTableView headerEndRefreshing];//停止下拉刷新
//    [self.WithdrawalOfRecordTableView footerEndRefreshing];//停止上拉刷新
...
//            [self.WithdrawalOfRecordTableView footerEndRefreshing];//停止下拉刷新
            [self.WithdrawalOfRecordTableView.footer endRefreshing];
