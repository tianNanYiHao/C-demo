...
enum{
    ...
    REQUSET_getRedeemTranse, //请求赎回交易 62
    REQUSET_getHongBaolist, //请求红包列表 63
    REQUSET_getHoldingCode, //请求持有详情 64
    REQUSET_getEveryDayPrifit, //请求持有产品收益列表(每日盈亏) 65
    REQUSET_getMangeAccoutDetail,//请求我的账户 理财账户概况   66
    REQUSET_getRedeemOrderID, //请求赎回订单ID               67
    REQUSET_getRedeemCode,    //请求赎回验证码               68
    REQUSET_finalyRedeem,     //确认赎回                    69
