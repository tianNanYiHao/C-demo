...
- (IBAction)takeCashAct:(UIButton *)sender {
    ...
    if([self.amountTextField.text isEqual:@""]){
        ...
        [request takeCash:turnStr andPassword:self.passwordTextField.text andMobileMac:self.mobileMacTextField.text andCashType:@"1" andCardTag:newCardNumber andCardIdx:cardIdx];
    }
