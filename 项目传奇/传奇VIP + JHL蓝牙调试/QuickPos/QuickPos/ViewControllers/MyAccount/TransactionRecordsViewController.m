...
- (void)viewDidLoad {
    ...
    //自定义segmect
    HMSegmentedControl *segmentedControl = [[HMSegmentedControl alloc] initWithSectionTitles:@[ L(@"All"),L(@"Spending"),L(@"Income"), L(@"Withdrawal")]];
    ...
    segmentedControl.selectedTextColor = [Common hexStringToColor:@"#47a8ef"];
    segmentedControl.textColor = [UIColor darkGrayColor];
    segmentedControl.selectionIndicatorColor = [Common hexStringToColor:@"#47a8ef"];
