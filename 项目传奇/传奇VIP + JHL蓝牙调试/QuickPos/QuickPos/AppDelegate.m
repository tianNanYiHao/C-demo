...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //QQ分享
    //APP ID:1105050299  十六进制:41ddbabb
    //APP KEY:Wudxj7JidLKxPosR
    //设置分享到QQ/Qzone的应用Id，和分享url 链接
    [UMSocialQQHandler setQQWithAppId:@"1105050299" appKey:@"Wudxj7JidLKxPosR" url:@"http://www.pgyer.com/3zy8"];
    ...
    [UMSocialWechatHandler setWXAppId:@"wx2d12d0e858b51baf" appSecret:@"5f211e402f9b26675a3e16326d0c8915" url:@"http://www.pgyer.com/3zy8"];
    
    
    //友盟APPkey:5695bb63e0f55a6749000609
    [UMSocialData setAppKey:@"5695bb63e0f55a6749000609"];
