...
@interface TakingIDcardReverseViewController ()<UIActionSheetDelegate,UIViewControllerTransitioningDelegate,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationBarDelegate,ResponseData,GKImageCropControllerDelegate,GKImagePickerDelegate>{
