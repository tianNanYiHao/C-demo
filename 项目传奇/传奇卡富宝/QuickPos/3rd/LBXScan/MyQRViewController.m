...
- (void)createQR1
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:[NSString stringWithFormat:@"%@",self.money] size:_qrImgView.bounds.size];
    
    CGSize logoSize=CGSizeMake(30, 30);
    UIImageView* imageView = [self roundCornerWithImage:[UIImage imageNamed:@"icon"] size:logoSize];
    [LBXScanWrapper addImageViewLogo:_qrImgView centerLogoImageView:nil logoSize:logoSize];
...
- (void)createQR2
{
    ...
    UIImage *image = [LBXScanWrapper createQRWithString:[NSString stringWithFormat:@"%@",self.money] size:_qrImgView.bounds.size];
    //二维码上色
...
- (void)createQR3
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:[NSString stringWithFormat:@"%@",self.money]
