...
- (void)viewDidLoad {
    ...
    [[self.tabBar.items objectAtIndex:0] setSelectedImage:[[UIImage imageNamed:@"tab_serve_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    [[self.tabBar.items objectAtIndex:0] setTitleTextAttributes:@{NSForegroundColorAttributeName:[Common hexStringToColor:@"14b9d5"]} forState:UIControlStateSelected];
    
    [[self.tabBar.items objectAtIndex:1] setSelectedImage:[[UIImage imageNamed:@"tab_shop_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
     [[self.tabBar.items objectAtIndex:1] setTitleTextAttributes:@{NSForegroundColorAttributeName:[Common hexStringToColor:@"14b9d5"]} forState:UIControlStateSelected];
    
     [[self.tabBar.items objectAtIndex:2] setSelectedImage:[[UIImage imageNamed:@"tab_account_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
     [[self.tabBar.items objectAtIndex:2] setTitleTextAttributes:@{NSForegroundColorAttributeName:[Common hexStringToColor:@"14b9d5"]} forState:UIControlStateSelected];
