...
//    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"功能开发中..." message:@"" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
//    [alertView show];
    ...
    if ([[AppDelegate getUserBaseData].mobileNo length] > 0) {
        ...
        JingDongFViewController *JDvc = [[JingDongFViewController alloc]initWithNibName:@"JingDongFViewController" bundle:nil];
...
- (IBAction)fukuaiAction:(id)sender {
//    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"功能开发中..." message:@"" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
//    [alertView show];
...
- (void)viewDidLoad {
    ...
    //    [self creatADImage];
    self.ADImage.backgroundColor = [UIColor colorWithRed:39/255.0 green:44/255.0 blue:54/255.0 alpha:1];
...
-(void)setUpCollection:(NSDictionary*)dict isResult:(BOOL)isResult{
    ...
    if (!isResult) {
        ...
        NSArray *titleArr = @[@"掌上商城",@"个人充值",@"即时取",@"转账汇款",@"水电煤",@"手机充值",@"流量充值",@"克拉宝充值",@"余额查询",@"拍拍贷"];
        NSArray *imageArr = @[@"serve_shopping",@"serve_payment",@"serve_take",@"serve_transfer",@"serve_Waterr",@"serve_phone",@"serve_traffic",@"karaRe",@"serve_query",@"paipaidai"];
        NSArray *noteArr = @[@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@""];
        NSArray *channelArr = @[@"0001",@"0002",@"0003",@"0004",@"0005",@"0006",@"0007",@"0008",@"0009",@"0011"];
...
//        else if ([channelID isEqualToString:@"0010"]) {//个人付款
//            RechargeViewController *vc10 = [mainStoryboard instantiateViewControllerWithIdentifier:@"RechargeViewController"];
//            vc10.isRechargeViewController = NO;
//            [vcArr addObject:vc10];
//        }
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[AppDelegate getUserBaseData].mobileNo length] > 0) {
        ...
        if ([@"0002" isEqualToString:str]) {
            ...
            vc1.isRechargeViewController = YES;
        ...
        else if ([@"0011" isEqualToString:str]){
            
            PaipaiDaiViewController *ppvc = [[PaipaiDaiViewController alloc]init];
