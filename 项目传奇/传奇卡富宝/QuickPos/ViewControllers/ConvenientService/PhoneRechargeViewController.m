...
- (void)viewDidLoad {
    ...
    self.comfirtbtn.backgroundColor =[Common hexStringToColor:@"ebebeb"];
    self.comfirtbtn.enabled = NO;
    [self.comfirtbtn setTitleColor:[Common hexStringToColor:@"dcdcdc"] forState:UIControlStateNormal];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    self.comfirtbtn.backgroundColor =[Common hexStringToColor:@"14b9d5"];
    self.comfirtbtn.enabled = YES;
    [self.comfirtbtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
}
/*
