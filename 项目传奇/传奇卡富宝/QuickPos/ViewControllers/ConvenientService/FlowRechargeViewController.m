...
@property (weak, nonatomic) IBOutlet RadioButton *agree;
    ...
    for (UIView *view in _buttonView.subviews) {
        if ([view isKindOfClass:[UIButton class]]) {
            ...
            if (selectedBtn.tag == btn.tag ) {
                selectedBtn.backgroundColor = [Common hexStringToColor:@"14b9d5"];
        ...
        if ([view isKindOfClass:[UILabel class]]) {
            ...
            if ((flowLabel.tag-1008610)/2 == btn.tag-10010) {
                ...
                flowLabel.textColor = [Common hexStringToColor:@"14b9d5"];
