...
- (UIImageView *)mainImage{
    if (!_mainImage) {
        ...
        _mainImage.image = [UIImage imageNamed:@"pay_help-1"];
    }
    return _mainImage;
}
...
- (void)viewDidLoad {
    ...
    NSURLRequest *r = [NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://app.cqjrpay.com:8080/kfb1/download/rate/rate_kfb.html"]]];
