//
//  chooseBankCardListController.m
//  QuickPos
//
...
#import "ROllLabel.h"
@interface chooseBankCardListController ()<UITableViewDataSource,UITableViewDelegate,ResponseData>
{
...
@implementation chooseBankCardListController
@synthesize name;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    _chooseBankCardNumBlock([NSString stringWithFormat:@"%d",indexPath.row]);
