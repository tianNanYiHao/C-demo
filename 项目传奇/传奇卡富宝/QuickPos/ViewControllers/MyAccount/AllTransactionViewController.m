...
//    self.AlltransactionTableView.footer = [BoRefreshAutoStateFooter footerWithRefreshingTarget:self refreshingAction:@selector(OnPull)];
    ...
    self.AlltransactionTableView.separatorStyle = UITableViewCellSeparatorStyleSingleLine;
}
...
//    bottom.backgroundColor = [Common hexStringToColor:@"F4F4F4"];
//    self.month = [[UILabel alloc]initWithFrame:CGRectMake(15, 0, 200, 35)];
////    NSMutableString *monthstr = [NSMutableString stringWithString:tableViewArray[0][@"date"]];
////    self.month.text = [monthstr substringWithRange:NSMakeRange(4, 2)];
//    self.month.text = @"06月";
//    [bottom addSubview:self.month];
//    return bottom;
//}
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *dateStr = [str2 substringFromIndex:5];
    cell.dataLabel.text = dateStr;
    NSDate *date = [NSDate dateByString:str2 AndFromat:@"YY-MM-dd"];
    NSString *weekend = [NSDate stringByDate:date AndFromat:@"E"];
    cell.weekend.text = weekend;
    cell.amountLabel.adjustsFontSizeToFitWidth = YES;
    cell.titleNameLabel.adjustsFontSizeToFitWidth = YES;

    NSString *urlstring = dic[@"icon"];
