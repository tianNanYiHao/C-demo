...
@interface LoginViewController ()<ABCIntroViewDelegate,CLLocationManagerDelegate,ResponseData,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate>{
...
@property (strong, nonatomic) NSMutableArray *fakeData;//存放假数据
...
-(void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations{
    ...
    [AppDelegate getUserBaseData].lon = coordinate.longitude;
    [AppDelegate getUserBaseData].lat = coordinate.latitude;
