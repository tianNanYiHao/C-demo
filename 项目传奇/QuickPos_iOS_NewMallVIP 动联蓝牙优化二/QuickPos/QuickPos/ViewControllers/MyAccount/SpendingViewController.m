...
- (void)viewDidLoad {
    ...
    //刷新方法事件
//    [self.spendingTableView addHeaderWithTarget:self action:@selector(dropDown)];
//    [self.spendingTableView addFooterWithTarget:self action:@selector(OnPull)];
...
//    [self.spendingTableView headerEndRefreshing];//停止下拉刷新
//    [self.spendingTableView footerEndRefreshing];//停止上拉刷新
...
//            [self.spendingTableView footerEndRefreshing];//停止下拉刷新
            [self.spendingTableView.footer endRefreshing];
