...
- (void)updateVersion{
    //启动更新检查SDK
    [[PgyUpdateManager sharedPgyManager] startManagerWithAppId:@"c7d846a5792abf0fc7f8e092f640c333"];
...
-(void)setUpCollection:(NSDictionary*)dict isResult:(BOOL)isResult{
    ...
    if (!isResult) {
        ...
        NSArray *titleArr = @[@"掌上商城",@"个人充值",@"即时取",@"转账汇款",@"水电煤",@"手机充值",@"流量充值",@"余额查询",@"个人付款"];
        
        NSArray *imageArr = @[@"serve_shopping",@"serve_payment",@"serve_take",@"serve_transfer",@"serve_Waterr",@"serve_phone",@"serve_traffic",@"serve_query",@"Percollect"];
        
        NSArray *noteArr = @[@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@""];
        NSArray *channelArr = @[@"0001",@"0002",@"0003",@"0005",@"0006",@"0007",@"0008",@"0009",@"0011"];
...
-(void)initViewController{
    ...
    for (NSDictionary *item in self.menuDataArr) {
        ...
        else if ([channelID isEqualToString:@"0006"]) {//水电煤
        ...
        else if ([channelID isEqualToString:@"0008"]) {//流量充值
        ...
        //
        //        }
        else if ([channelID isEqualToString:@"0005"]) {//转账汇款
//            WithdrawalViewController *vc5 = [mainStoryboard instantiateViewControllerWithIdentifier:@"WithdrawalVC"];
//            vc5.destinationType = TRANSFER;
//            vc5.item = item;
//            [vcArr addObject:vc5];
        ...
        else if ([channelID isEqualToString:@"0007"]) {//手机充值
        ...
        else if ([channelID isEqualToString:@"0011"]){//个人付款
            
            RechargeViewController *vc8 = [mainStoryboard instantiateViewControllerWithIdentifier:@"RechargeViewController"];
            vc8.isRechargeViewController = NO;
            [vcArr addObject:vc8];
        }
        else{
