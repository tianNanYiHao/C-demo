...
//    [self.messageTableView addHeaderWithTarget:self action:@selector(dropDown)];
//    [self.messageTableView addFooterWithTarget:self action:@selector(OnPull)];
...
//    [self.messageTableView headerEndRefreshing];//停止下拉刷新
//    [self.messageTableView footerEndRefreshing];//停止上拉刷新
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIStoryboard *messageVC = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    
    MessageDetailViewController *messageDetailVC = [messageVC instantiateViewControllerWithIdentifier:@"MessageDetailViewID"];
    ...
    if([dic[@"msgTitle"] isEqual:@""]){
        ...
        messageDetailVC.titleStr = L(@"NoTitle");
        
        
    }else{
        
        messageDetailVC.titleStr = dic[@"msgTitle"];
        NSLog(@"%@",messageDetailVC.titleStr);
        NSLog(@"%@",dic[@"msgTitle"]);
    ...
    if([dic[@"msgDetial"] isEqual:@""]){
        ...
        messageDetailVC.descriptionStr = L(@"NoTitle");
        
        
    }else{
        
        messageDetailVC.descriptionStr = dic[@"msgDetial"];
        
        NSLog(@"%@",messageDetailVC.descriptionStr);
    }
    ...
    messageDetailVC.timeStr = date;
    
    
    
    
    //    messageDetailVC.TitleLabel.text = dic[@"msgTitle"];
    //    messageDetailVC.TimeLabel.text = dic[@"sendTime"];
    //    messageDetailVC.DescriptionLabel.text = dic[@"msgDetial"];
