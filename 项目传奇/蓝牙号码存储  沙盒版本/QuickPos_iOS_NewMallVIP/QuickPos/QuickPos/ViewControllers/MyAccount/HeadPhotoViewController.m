...
@interface HeadPhotoViewController ()<UIActionSheetDelegate,UIViewControllerTransitioningDelegate,UIImagePickerControllerDelegate,UINavigationBarDelegate,ResponseData,GKImageCropControllerDelegate,GKImagePickerDelegate>{
