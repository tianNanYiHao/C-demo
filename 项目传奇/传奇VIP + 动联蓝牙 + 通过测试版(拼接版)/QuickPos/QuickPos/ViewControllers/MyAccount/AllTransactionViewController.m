...
////////////////////////////////////////////////////////////////////
    ...
    //刷新方法事件
//    [self.AlltransactionTableView addHeaderWithTarget:self action:@selector(dropDown)];
//    [self.AlltransactionTableView addFooterWithTarget:self action:@selector(OnPull)];
...
//    [self.AlltransactionTableView headerEndRefreshing];//停止下拉刷新
//    [self.AlltransactionTableView footerEndRefreshing];//停止上拉刷新
