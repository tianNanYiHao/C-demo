...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
       ...
       [[UIApplication sharedApplication] setStatusBarHidden:YES];
        ...
        self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height*0.83, self.frame.size.width, 10)];
...
//    [view addSubview:imageview];
    ...
    //Done Button
    doneButton = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width*0.192, self.frame.size.height*.85, self.frame.size.width*0.6, 50)];
    [doneButton setTintColor:[UIColor whiteColor]];
